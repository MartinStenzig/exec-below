...
module.exports = function (aCommandToExecute, aParameterArray, executionOptions) {
  ...
  _optionProcessingDepth = executionOptions.depth || 9999
  _optionStartingPath = executionOptions.startPath || '.'
...
function _executeCommand(aDirectoryName) {
  return new Promise((resolve, reject) => {
    ...
    if (_verbose) {
      console.log("- Execute Command '" + command.trim() + "' with parameters: ", params, 'in directory: ', aDirectoryName)
    }
